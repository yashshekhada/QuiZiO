...
public class CircleTimer extends View {
    ...
    public CircleTimer(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public void SetTimerAttributes(int progressColor, int textColor) {
        ...
        textPaint.setTypeface(Typeface.create(Typeface.SERIF, Typeface.BOLD));
        textPaint.setTextSize(sp2px(Constant.PROGRESS_TEXT_SIZE));
    ...
    public final class PatternProgressTextAdapter implements CircleTimer.ProgressTextAdapter {
    ...
    public final class DefaultProgressTextAdapter implements CircleTimer.ProgressTextAdapter {
