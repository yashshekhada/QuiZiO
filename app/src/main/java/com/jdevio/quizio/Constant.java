...
public class Constant {
    ...
    public static String QUIZ_URL = "http://jdevio.com/QuiziO/Admin/quiz_5_4/api-v2.php";  //api url

    public static String FIREBASE_URL = "https://us-central1-govqz-264109.cloudfunctions.net/create/";/*FireBase function URL*/
    /////// PARAMETERS  ///////
