...
public class AudienceProgress extends View {
    ...
    public AudienceProgress(Context context) {
        super(context);
        init(context, null);
    }

    public AudienceProgress(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public AudienceProgress(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public AudienceProgress(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CircleTimer);
            ...
            textColor = a.getColor(R.styleable.CircleTimer_textColor, progressColor);
            textSize = a.getDimensionPixelSize(R.styleable.CircleTimer_textSize, textSize);

            shouldDrawDot = a.getBoolean(R.styleable.CircleTimer_drawDot, shouldDrawDot);
            dotColor = a.getColor(R.styleable.CircleTimer_dotColor, progressColor);
            dotWidth = a.getDimensionPixelSize(R.styleable.CircleTimer_dotWidth, progressStrokeWidth);
    ...
    public void SetAttributes() {
        setProgressColor(Color.parseColor(Constant.PROGRESS_COLOR));
        setDotColor(Color.parseColor(Constant.PROGRESS_COLOR));
        setProgressBackgroundColor(Color.parseColor(Constant.PROGRESS_BG_COLOR));
        setTextColor(Color.parseColor(Constant.PROGRESS_COLOR));
        textPaint = new TextPaint();
        textPaint.setStrokeCap(Paint.Cap.ROUND);
        textPaint.setTypeface(Typeface.create(Typeface.SERIF, Typeface.NORMAL));
        textPaint.setColor(Color.parseColor(Constant.PROGRESS_COLOR));
        textPaint.setTextSize(sp2px(10));
        setProgressStrokeWidthDp(Constant.PROGRESS_STROKE_WIDTH);
        setDotWidthDp(Constant.PROGRESS_STROKE_WIDTH);
    }
    ...
    public void SetAttributesForStatistics(Context context) {
        setProgressColor(ContextCompat.getColor(context, R.color.correct));
        setDotColor(ContextCompat.getColor(context, R.color.correct));
        setProgressBackgroundColor(ContextCompat.getColor(context, R.color.incorrect));
        textPaint = new TextPaint();
        textPaint.setStrokeCap(Paint.Cap.ROUND);
        textPaint.setAntiAlias(true);
        textPaint.setColor(Color.WHITE);
        textPaint.setTypeface(Typeface.create(Typeface.SERIF, Typeface.NORMAL));
        textPaint.setTextSize(sp2px(1));
    ...
    public final class PatternProgressTextAdapter implements AudienceProgress.ProgressTextAdapter {
    ...
    public final class DefaultProgressTextAdapter implements AudienceProgress.ProgressTextAdapter {
